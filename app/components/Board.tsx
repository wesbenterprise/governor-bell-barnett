    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
        {[
          ...
          <div key={s.label} className="bg-[#0f2040] border border-[#1a3a6b] rounded-xl p-4 text-center">
            <p
              className="text-2xl font-bold text-[#F4811F]"
              style={{ fontFamily: "var(--font-orbitron-var), Orbitron, sans-serif" }}
            >
              {s.value}
            </p>
      ...
      <div className="mb-6 p-4 rounded-xl bg-[#0f2040] border border-[#1a3a6b]">
        <p className="text-xs text-[#a0b8d0] leading-relaxed">
          <span className="text-[#F4811F] font-semibold">About the BOG:</span> The Florida Board of
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 mb-4">
          <div className="w-1 h-5 bg-[#F4811F] rounded"></div>
          <h3
          ...
          {appointed.map((member) => (
            <div
              ...
              className={`rounded-xl border p-4 transition-all duration-200 ${
                member.isSubject
                  ? "bg-[#0d1f38] border-[#F4811F]/50 shadow-[0_0_16px_rgba(201,168,76,0.1)]"
                  ...
                  <div className="flex items-center gap-2 mb-0.5">
                    <h4
                      className={`text-sm font-bold leading-tight ${
                        member.isSubject ? "text-[#F4811F]" : "text-white"
                      }`}
                      style={{ fontFamily: "var(--font-orbitron-var), Orbitron, sans-serif" }}
                    >
                      {member.name}
                    ...
                    {member.isSubject && (
                      <span className="text-[10px] px-1.5 py-0.5 rounded bg-[#F4811F]/15 text-[#F4811F] border border-[#F4811F]/40 font-bold uppercase tracking-wide flex-shrink-0">
                        ★ You
                      </span>
                    )}
                  </div>
